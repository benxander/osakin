...
;(function($) {
	...
	var disclosure = function(options) {
		...
		if(settings.explicitConsent) {
			...
			html += settings.explicitFindOutMore + '<a title="Política de Cookies" rel="shadowbox" style="color:'+ settings.linkColor + ';font-weight:bold;';
			...
			html += scriptsDisclosure + settings.impliedDisclosureText + ' <a title="Política de Cookies" rel="shadowbox" style="color:'+ settings.linkColor + ';';
